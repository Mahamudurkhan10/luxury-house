     ...
     return (
          <div className="carousel w-full h-[450px]">
               <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                         <a href="#slide4" className="btn btn-circle">❮</a>
                           <div className="text-center w-3/5"> <h1 className="text-white text-4xl font-bold">
                              Discover your own private oasis,
                              Where tranquility meets extravagance in perfect harmony.
                            
                               </h1>
                               <button className="btn btn-success text-xl mt-8 pb-1 text-white rounded-xl" > Read More</button>
                               </div>
               ...
               <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                         <a href="#slide2" className="btn btn-circle">❮</a>
                         <div className="text-center w-3/5"> <h1 className="text-sky-400   text-4xl font-bold">
                              Discover your own private oasis,
                              Where tranquility meets extravagance in perfect harmony.
               ...
               <div id="slide4" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                         <a href="#slide3" className="btn btn-circle">❮</a>
                         <div className="text-center w-3/5"> <h1 className="text-gray-100   text-4xl font-bold">
                              Discover your own private oasis,
                              Where tranquility meets extravagance in perfect harmony.
